...
Create new files in `~/memory/` for knowledge that doesn't fit in `user.md` — portfolio rules, strategy assumptions, market convictions. Add a pointer to `MEMORY.md` for each new file.
