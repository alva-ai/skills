...
| `deploy`             | Cronjob lifecycle for producer scripts: schedule, args, runs, logs. See [deployment.md](references/deployment.md).                                                                    |
...
| [deployment.md](references/deployment.md)                                             | Cronjob create/list/pause/resume/runs/run-logs.                                                                                               |
