...
For questions about an existing or quoted Thesis, first read [thesis-context.md](references/thesis-context.md); keep this read-only and preserve the selected author version. For Thesis work, follow [thesis.md](references/thesis.md). Use guided creation when publication intent lacks a final body; do not build HTML, Automation, or a draft/release workflow.
